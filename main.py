...
def main():
    dire = "/Users/ketian/Desktop/phishingDetect/1"
    cans = read_pngs_sources_from_directory(dire)
    ...
    for c in cans:
        ...
        if  os.path.exists(c.web_source) and os.path.exists(c.web_img) :
            ...
            print ("NLP analysis")
            ocr_detect.get_html_text(c.web_source)
            pass

            try:
                print ("Image analysis")
                ocr_detect.get_img_text_ocr(c.web_img)
            except:
                pass

            print ("Structure analysis")
            ocr_detect.get_structure_info(c.web_source)
            pass
